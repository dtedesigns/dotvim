...
syn keyword htmlTagName contained footer header hgroup keygen mark meter
syn keyword htmlTagName contained nav output progress rp rt ruby section
syn keyword htmlTagName contained source summary time video
