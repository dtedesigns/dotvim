...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/kevin/.eclipse/org.eclipse.platform_3.5.0_155965261/plugins/org.eclim_1.5.8'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/kevin/.eclipse/org.eclipse.platform_3.5.0_155965261'
  if has('win32unix')
